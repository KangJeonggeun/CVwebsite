...
const SkillsSection = () => {
  ...
  const renderSectionTitle = (): React.ReactNode => {
    return (
      <div className="flex flex-col">
        <p className="section-title-sm seq">{t("skills.1")}</p>
        <h1 className="section-heading seq mt-2">{t("skills.2")}</h1>
  ...
  const renderSkillColumn = (title: any, skills: string[]): React.ReactNode => (
    <>
    ...
    <section className="relative">
      ...
      >
        <div className="flex flex-col skills-wrapper">
          {renderSectionTitle()}
          <div className="mt-10">
            {renderSkillColumn(t("skills.4"), SKILLS.frontend)}
          </div>
          <div className="flex flex-wrap mt-10">
            <div className="mr-6 mb-6">
              {renderSkillColumn(t("skills.5"), SKILLS.userInterface)}
            </div>
            <div>{renderSkillColumn(t("skills.6"), SKILLS.other)}</div>
          </div>
        </div>
      </div>
    </section>
